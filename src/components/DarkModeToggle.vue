<template>
  <button
    ...
    :class="
      ['p-2 rounded-md bg-transparent hover:bg-gray-300 dark:hover:bg-gray-700', variant === 'sm' ? 'p-1' : ''].join(
        ' ',
      )
    "
    style="outline: none !important; border: none !important"
  >
    <svg :class="['hidden dark:block', 'w-5 h-5']" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
      <path
        fill="currentColor"
